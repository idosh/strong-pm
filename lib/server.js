...
function Server(cmd, baseDir, listenPort, controlPath, enableTracing) {
  this._originalCommand = cmd;
  ...
  this._serviceManager = new ServiceManager(this, enableTracing);
  ...
  this._app = meshServer(this._serviceManager, options);
